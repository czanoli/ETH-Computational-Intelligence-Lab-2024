...
def train_fasttext(input_path):
    ...
    try:
        ...
        logger.info(
            ...
            "Then make predictions with the following command:\n"
            ">> src/models/fastText-0.9.2/fasttext predict models/fasttext_model.bin data/processed/test.txt > results/fasttext_predictions.txt"
        )
