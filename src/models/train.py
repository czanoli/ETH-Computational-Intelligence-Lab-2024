...
def main(input_path, method, embedding, hparams_tuning, save, validation=False):
    ...
    if method == "base-ensemble-random-forest":
        ensembles.random_forest(["data/embeddings/finetuned-bertweet-base_train_small.pt", "data/embeddings/finetuned-twitter-roberta-base-sentiment-latest_train_small.pt"],"data/processed/train_small.csv",["data/embeddings/finetuned-bertweet-base_test.pt","data/embeddings/finetuned-twitter-roberta-base-sentiment-latest_test.pt"],validation=validation)
    ...
    if method == "base-ensemble-nn":
        ensembles.ensemble(["data/embeddings/finetuned-bertweet-base_train_small.pt", "data/embeddings/finetuned-twitter-roberta-base-sentiment-latest_train_small.pt"],"data/processed/train_small.csv",["data/embeddings/finetuned-bertweet-base_test.pt","data/embeddings/finetuned-twitter-roberta-base-sentiment-latest_test.pt"], config, validation=validation)
