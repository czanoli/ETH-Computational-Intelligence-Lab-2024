...
@click.option('--method', type=click.Choice(['classifiers', 'fastText', 'CNN', 'CNN-LSTM','LSTM-CNN','twitter-roberta-base-sentiment-latest','lora-roberta-large-sentiment-latest','bertweet-base','lora-bertweet-large','base-ensemble-random-forest','large-ensemble-random-forest','full-ensemble-random-forest','large-ensemble-nn','base-ensemble-nn','full-ensemble-nn']), required=True, help='Method to use for training')
...
def main(input_path, method, embedding, hparams_tuning, save, validation=False):
    ...
    if method == "base-ensemble-random-forest":
        ensembles.random_forest(["data/embeddings/finetuned-bertweet-base_train_small.pt", "data/embeddings/finetuned-twitter-roberta-base-sentiment-latest_train_small.pt"],"data/processed_llm/train_small.csv",["data/embeddings/finetuned-bertweet-base_test.pt","data/embeddings/finetuned-twitter-roberta-base-sentiment-latest_test.pt"],validation=validation)
    if method == "large-ensemble-random-forest":
        ensembles.random_forest(["data/embeddings/lora-bertweet-large_train_small.pt", "data/embeddings/lora-twitter-roberta-large-topic-sentiment-latest_train_small.pt"],"data/processed_llm/train_small.csv",["data/embeddings/lora-bertweet-large_test.pt","data/embeddings/lora-twitter-roberta-large-topic-sentiment-latest_test.pt"], validation=validation)
    if method == "full-ensemble-random-forest":
        ensembles.random_forest(["data/embeddings/lora-bertweet-large_train_small.pt", "data/embeddings/lora-twitter-roberta-large-topic-sentiment-latest_train_small.pt","data/embeddings/finetuned-bertweet-base_train_small.pt","data/embeddings/finetuned-twitter-roberta-base-sentiment-latest_train_small.pt"],"data/processed_llm/train_small.csv",["data/embeddings/lora-bertweet-large_test.pt","data/embeddings/lora-twitter-roberta-large-topic-sentiment-latest_test.pt","data/embeddings/finetuned-bertweet-base_test.pt","data/embeddings/finetuned-twitter-roberta-base-sentiment-latest_test.pt"],validation=validation)
    ...
    if method == "base-ensemble-nn":
        ensembles.ensemble(["data/embeddings/finetuned-bertweet-base_train_small.pt", "data/embeddings/finetuned-twitter-roberta-base-sentiment-latest_train_small.pt"],"data/processed_llm/train_small.csv",["data/embeddings/finetuned-bertweet-base_test.pt","data/embeddings/finetuned-twitter-roberta-base-sentiment-latest_test.pt"], config, validation=validation)
    if method == "full-ensemble-nn":
        ensembles.ensemble(["data/embeddings/lora-bertweet-large_train_small.pt", "data/embeddings/lora-twitter-roberta-large-topic-sentiment-latest_train_small.pt","data/embeddings/finetuned-bertweet-base_train_small.pt", "data/embeddings/finetuned-twitter-roberta-base-sentiment-latest_train_small.pt"],"data/processed_llm/train_small.csv",["data/embeddings/lora-bertweet-large_test.pt","data/embeddings/lora-twitter-roberta-large-topic-sentiment-latest_test.pt","data/embeddings/finetuned-bertweet-base_test.pt","data/embeddings/finetuned-twitter-roberta-base-sentiment-latest_test.pt"], config, validation=validation)
